                ...
                {isHost && (view === 'waiting') ? ( // render if host and viewing waiting room
                    <div className="flex flex-col items-center space-y-4">
                        ...
                        <button className={`text-[var(--dark)] rounded-lg p-2 transition duration-500 shadow-md
                            ...
                            : 'bg-[var(--primary)] hover:brightness-80 hover:cursor-pointer hover:scale-105 animate-bounce'}`} onClick={()=> onStartGame(playerContextObj.roomCode, playerContextObj.playerCode)} 
