...
const RevealRoleCard = ({ role, location, onContinue }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-10">
            <Card title="The game is about to begin!" className="p-6 mt-6 w-fit h-fit flex flex-col space-y-4">
                ...
                <button className="flex items-center justify-center lg:mx-auto lg:w-1/2 gap-2 space-x-2 py-2 px-4 rounded-3xl font-medium transition text-[var(--dark)]
                    duration-500 shadow-md bg-[var(--primary)] hover:bg-[var(--primary)] hover:brightness-80 hover:cursor-pointer hover:scale-105" 
                    onClick={onContinue}>
                    Continue
