...
const PlayerCard = ({ location, role, setModalSpyGuess }) => {
    ...
    return (
        <Card className="p-6 h-fit space-y-4 transition duration-500"
            title="Role & Location"
        >
            ...
            >
                <div className={`transition-all duration-500 ${isRoleRevealed ? 'opacity-0' : 'opacity-100'}`}>
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-[var(--secondary)] dark:bg-[var(--secondary-dark)] rounded-lg">
                        <span className="flex justify-center text-[var(--dark)]/50 dark:text-[var(--light)]/50">Hover or Click to Reveal</span>
